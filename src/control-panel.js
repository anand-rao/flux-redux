...
const fornSizePreferenceUpdateAction = (size)=>{
	return {
...
const userPrefsStore = new UserPrefStore(controlPanelDispatcher);
...
document.forms.fontSizeForm.fontSize.forEach(element=>{
	element.addEventListener('change',({target})=>{
		controlPanelDispatcher.dispatch(fornSizePreferenceUpdateAction(target.value));
	});
})
